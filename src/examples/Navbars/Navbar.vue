        ...
        <ul class="navbar-nav justify-content-end">
          <li class="nav-item d-flex align-items-center">
            <a
              ...
              @click="logout"
            >
              <i class="fa fa-power-off" :class="isRTL ? 'ms-sm-2' : 'me-sm-1'"></i>
...
<!--&lt;!&ndash;            <a&ndash;&gt;-->
<!--&lt;!&ndash;              class="p-0 nav-link"&ndash;&gt;-->
<!--&lt;!&ndash;              :class="textWhite ? textWhite : 'text-body'"&ndash;&gt;-->
<!--&lt;!&ndash;              @click="toggleConfigurator"&ndash;&gt;-->
<!--&lt;!&ndash;            >&ndash;&gt;-->
<!--&lt;!&ndash;              <i class="cursor-pointer fa fa-cog fixed-plugin-button-nav"></i>&ndash;&gt;-->
<!--&lt;!&ndash;            </a>&ndash;&gt;-->
<!--          </li>-->
          &nbsp;
<!--          <li-->
<!--            class=" nav-item ps-2 dropdown d-flex align-items-center"-->
...
export default {
  ...
  computed: {
    ...
    currentDirectory2() {
      let dir = this.$route.path.split("/")[2];
      return dir.charAt(0).toUpperCase() + dir.slice(1);
    },
  },
  created() {
    this.minNav;
    try {
      this.name= JSON.parse(localStorage.getItem('user')).firstName + " " + JSON.parse(localStorage.getItem('user')).lastName;
    }catch (e) {
      // console.log(e)
    }
  },
  methods: {
    ...
    logout() {
      try {
        ...
        window.location.href = '/policeRecords/login'
      } catch (e) {
        console.log(e)
      }
    },
